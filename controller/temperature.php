<?php
	...
	{
		$uri      = "http://lightcontrollerwebservice20171205094253.azurewebsites.net/Service1.svc/temperature";
		$jsonData = file_get_contents($uri);
		//print_r($jsonData);

		//Parse JSON to Array.
		$temperature = json_decode($jsonData, true);
		...
		$outputTemperature = array_slice($temperature, 0, 5);
		foreach($outputTemperature as $temp)
		{
			echo "<td> " . $temp["Temperatur"] . "°</td>";
		}
	}